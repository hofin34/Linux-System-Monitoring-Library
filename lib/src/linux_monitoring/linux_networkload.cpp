 ...
 *
 */
#include <linux_monitoring/linux_networkload.hpp>
#include <string>
#include <exception>
#include <fstream>
#include <iostream>
...
namespace linux_monitoring {
    ...
    networkLoad::networkLoad(std::string ethernetDataFileName, std::string ethName) : ethernetDataFile(
            std::move(ethernetDataFileName)), ethDev(std::move(ethName)) {
